    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#ffe6ff;">
        ...
        <footer id="footer">
            <div class="container-fluid text-center rounded bg-light p-2">
                ...
                <div class="credits">
                    Designed by <a href="https://bootstrapmade.com/">Shrruthilaya G</a>
                </div>
            </div>
        </footer>
    </div>
...
### GD Message Page:
![ouput](gdmessagepage1.jpg)
![output](gdmessagepage2.jpg)

### About Us - Evolution Page:
![output](aboutuspage1.jpg)
![output](aboutuspage2.jpg)
